...
from .views import CreateOrderView, CustomerList, DeleteOrderView, OrderEditstatus, OrderList, PaidOrderView, PayOrderView, ProductList, OrderDetail, UnpaidOrderView
